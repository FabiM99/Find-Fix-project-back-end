...
const registerPro = {
  ...
  handler: async (req, res) => {
    const { nome, cognome, città, email, password, provincia, telefono, categoria_servizi, nome_azienda, p_iva, codiceFiscale, descrizioneProfessionista, tipo_abbonamento, profilePhotoName, profilePhotoPath, costo, } = req.body;
    ...
    try {
      ...
      const userId = (await connection.query('SELECT LAST_INSERT_ID() AS id'))[0].id;
